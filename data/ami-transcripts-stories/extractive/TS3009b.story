...
I I disagree , because we just said we wanted to d include the D_V_D_ and they don't want it , because uh especially for the third requirement we want to reach people under the thirty years .
...
Well , um the first findings are that people um think most controls are very kind of ug ugly .
...
So it might be sensible to make some kind of a button on your television , that's your um your control beeps or something , that you can find this very easily .
...
Uh Yeah but nobody reads a manual about a remote control , I think .
...
Um research shows that they like to have a little L_C_D_ screen on their on their uh zapping uh device .

@highlight

Uh I thought it was the age between sixteen and twenty , ninety nine per cent of uh the people like that .
...
So No , we'll look we'll look into that later .
...
They also like that , I think that's uh difficult to realise also .
...
You have uh basically uh the energy , the power of the of the remote control , And the the user interface sends uh the the different signals of the different buttons to the chip , I've some couple of pictures here .

@highlight

It has uh very little buttons and High tech .
...
So we have to uh change a little bit uh to that , uh so that uh it becomes more user-friendly , But I think it's very important to make um the power , channel and volume buttons uh near to the thumb , so you can't have R_S_I_ uh consequences .
...
and uh and that the less important uh buttons , like the the the different channels , uh the numbers one two three four five as well , should be uh yeah well not in reach , And I have some pictures of the inside workings , Yeah .
...
took a good l look uh at the remotes on the corporate website , which are these two .

@highlight

Um This one is engineering-centred , I like user-centr centred uh uh also the best .
...
So the symbol's always on We can make a symbol of the company right here .
...
and we've uh chose for the younger one .
...
Like L_C_D_ screens and voice recognition .
...
So it it just signals the the different uh sig uh the different symbols on the screen you have , I think it should be at the top .

@highlight

Alright , we go with the L_C_D_ screen ?
...
Um Yeah well we we we still need to know how much that will cost .
...
Yeah but with with the L_C_D_ screen on the top it gets a bit unnatural .
...
I think it's still important to have it at the top , because it's uh it's more familiar that way .

@highlight

I think we have uh a few functions , and we can put uh the L_C_D_ above it , and still have lots of room at the bottom , where you can put your hand .

@highlight

Well but uh what what if we we first decide the different functions , We have a power button , setting buttons , L_C_D_ window , the number buttons Channel , yeah .
...
I think we we should use something like this um to um The the channel up and channel down button ?
...
Yeah , but what he said about R_S_I_ was t kinda true .
...
On most T_V_s if you uh press two numbers shortly after each other , d it Alright so no button for that .
...
You can just put it somewhere Oh , they can be small or round like buttons .

@highlight

Well uh and and I think more at the bottom .
...
So So it's better to uh put our attention to the the design .
...
Now the LED produces an infrared beam and signals the , well it's uh very simple , and signals the uh signals to the sensor on the T_V_ set , but the most important buttons m maybe you can just put them a bit apart so you would reject R_ R_S_I_ R_S_I_ .
