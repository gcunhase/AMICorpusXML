...
and we speak about this tool we're going to design and try to make a project plan , Um I think the important points we have to t talk about are uh it's functional design , it's conceptual design , and desail detailed design .
...
but mainly it has to be very robust colourful , maybe No , that's a good idea .
...
like the phones and these things we c yeah .
...
Should it be , y you know these uh remote controls where um they are what they call a universal ret remote control at least it should hold in your hand n properly , like .
...
So , some kind of idea uh with um um cellular phone with a a screen that will tell you what Too expensive for twelve Euro ?
...
and if I'm left-hander I use this switch to follow the main operations .
...
but for instance when you change channels you can have you can just go to the next one or go to channel twenty five .
...
And then back to the one I was before , yeah , that would be cool .
...
Um we're going to meet again in thirty minutes and uh I want you to mm work on these ideas and try to make a uh the ones , make um to decide what what are the ones important and what are the one that we don't want .
