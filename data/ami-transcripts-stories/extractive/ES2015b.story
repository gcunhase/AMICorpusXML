...
the first presentation we'll be looking at is Poppy's presentation .
...
Um , so I was looking at how we're going to go about the working design , Uh , on a functional side of things , we found out that wh from our previous meeting , we decided that there're certain points that will make our product unique .

@highlight

Um , one is the visibility in the dark , And we could use illuminated buttons , Or we could use fluorescent materials Um , also we could use um an alarm .

@highlight

So if we lost the um remote control , perhaps there could be a button on the television set itself , which you could press , Um , another thing I think we d missed out on on the last meeting was the fact that we should consider the environmental impact of our design .
...
So , all the um individual components could be easily separated , and then some could be reused , some could be recycled , I mean , the user would return the p product to the company , 'cause it's the product's responsibility to get rid of what they've made .
...
Um , so we'll have to investigate how much that will cost us , cost the company , Um also there is um components .
...
It could be a battery , And , um , the next presenter will be Tara .
...
Um , I think that a single function remote control would be preferable , It'd be more compatible with a range of television sets , making it more internationally sellable .
...
because we're trying to do so much , that if we're trying to make a unique , user-friendly , dadada , and it's also multi also multifunctional , um , we're gonna go over budget for one thing .
...
Any trends that are going on in , in the public , even media , Um , seventy five percent of users of remote controls find them ugly .
...
And another thing with um lots of surfing , we'd probably have to work on something that could be um a lot more durable , And actually to go with that , I'm gonna give you some statistics on the uh relevancy of the buttons , how much they're used .
...
it's just information that um , like television timetables , what's on , what's on now , what's on next , on every channel , and So it looks like something that we're gonna want to do some research on and include on our remote control .
...
Um , remote controls are bad for R_S_I_ .
...
And something that might further complicate it is that the T_V_ makes noise itself .
...
Um an L_C_D_ screen though might be something that , you know , you can shift through pages kind of li the way this PowerPoint is working .
...
so uh in my opinion it should be , um , user-friendly and unique .
...
But if we wanna make fifty million , and and have everyone want this remote control , we should maybe stick to the basics .
...
Um , for one thing , because Having controls with D_V_D_ , V_C_R_ , that sort of thing , would really complicate the design of the remote control .
...
but for the purposes of this meeting I , I wasn't offered a , like a type of logo or colour , It's probably R_ R_R_ in yellow .
...
Are we going to write off the L_C_D_ option ?

@highlight

So no L_C_D_ , no teletext , and no voice recognition .

@highlight

I don't use teletext that much , but if it was on your T_V_ , you'd want to be able to use it , It was a management decision , so it's , it's pretty much out of our hands at this point .
...
We could , may , possibly , sorry , incorporate them both so that the buttons could maybe be in the shape of the numbers themselves and be made out of some glow-in-the-dark material .
...
I guess the other option , referring to the battery thing is , you know how cellphones will t light up for fifteen seconds or something , when you're s and then it goes , Um , if instead of a constant light up on the , on the remote control , if it lights up for ten seconds when it's touched again .
...
it might be perceived as tacky , glow-in-the-dark .
...
Um , the environmental factor , we didn't bring that up again .
