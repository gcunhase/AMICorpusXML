...
you just have a a very simple chip and the mm the user interface is just done usually by push button and in our case we are using a um a wheel control .
...
Yeah you reco recognize commands and you can record new commands and stuff , the I I just want to mention the the problem of the the r wheels sensor which is much more expensive than any push button , We we have already some good things uh with um um with the backlight of the push button .
...
I don't think that this is really expensive , Yeah , but I expected also the wheel would be cheap but you tell me that it is very expensive so , But it can be uh battery consuming , no ?
...
So it's basically more or less how we would like it , with a big volume control , big channel control , and mute and power , So basically , w software we will build will look more or less the same as these two .
...
I think that the volume and the buttons that are there on the top are not very easy to reach with your thumb .
...
And there is a fashion watchers in Paris and Milan that have detected the following trends , uh fruits and vegetables will be the most important theme for clothes , shoes , and furnitures .

@highlight

So , maybe if our remote control have to be a fruit form or vegetable form And the mm the material is expected to be spongy .

@highlight

I think we can certainly just put the electronics in a spongy thing , Yeah , because it's robust .
...
that's why I think we have to keep that if it's possible .
...
And for maybe look and feel , what about a a piece of ice , But that's not in the trend .
...
I think we can keep the wheel Banana is also yellow so you you can't lost your remote control then .

@highlight

but when the banana is curving like that , with the wheel on the top and to control , You can also take into account the fact that the banana fits with the colour scheme of our company .
...
chip imprint we know exactly which one we are going to use .
