...
discussed the possibility of a macro facility , interac interacting the T_V_ a bit more , um mentioning of bar-code , joystick for user manipulation , um and ergonomics of the remote control as well .
...
Remote control should only be used for the T_V_ .

@highlight

Um due for uh time to market and possibly also cost issues .
...
to the point in my opinion anyway that it might not be worth pursuing .
...
Um I'd like to if possible hear from our Marketing Expert first , Functional requirement by me Ebenezer .

@highlight

we did some research , we asked one hundred people their opinions on remote controls .

@highlight

We asked some uh open ended questions , and we asked some very specific questions , Please bear in mind this is only a hundred people , so even when the groups are divided into fifteen to twenty five , twenty five to thirty five , there's only maybe ten people fifteen people in each group .

@highlight

some the bad stuff we got , remotes are often lost .
...
there's just a lot of stuff that no one really uses .
...
I've seen some remote controls that are big , they have a lot of buttons , you have to hold down more than one key at one time to do something , Some of the good stuff we got .
...
um most people want remote controls to be pretty , they want it to be fancy , th they they want it to be different , Finally , my opinion .
...
It's a bit sketchy at some times , uh , you're not gonna get good always accurate results , but for a very fixed number of words , how many different words can you have for a remote control , up , down , left , right , channel five , channel seven , For a fixed vocabulary it works quite well .
...
I mean most people use a remote control for switching to channels , So if you have to say up , up , up , up , if you have to do that all the time , then people might get a bit fed up with that However , oh , because the voice recognition software exists already , there's no need to spend money on research and development , but this does mean the need for microphones in the in the remote control , which is an unusual feature in my opinion .
...
Either you have voice recognition by itself , which I think is a bit impractical for like night time if you wanna be watching television and you wanna be quiet , or I don't know you have a visitor coming round and the remote's only trained for you , it's a bit impractical to have just voice recognition by itself .
...
this is a brief run through of the um of the technical functions of the remote .

@highlight

the presentation is uh already slightly obsolete because I had in mind something that would uh be i be aimed at controlling multiple devices I've looked at looked at a num uh couple of other uh remote control models just for an idea of basic design principles .

@highlight

Um Um um basically the job of the device is to send commands to an appliance , in this case the television set .
...
On the one hand and this uh this particularly relates to its sort of earliest models where with you know i so so many buttons on it Um giving you every possible function that the that the device has , the remote control controls .

@highlight

it creates a rather user unfriendly interface .
...
Um and of course there is a certain amount of sort of loss of function here obviously , And so you go for something that's fairly intuitive to use , My own view is that we should definitely be going for a user focused design .
...
something that's uh something that is more programmable , that uh perh perhaps has the full range of functions available to it but you can then specify yourself what you're most likely to want .

@highlight

um I liked Ebenezer's idea of including a joystick in that and uh possibly a sort of fairly minimal number of sort of function buttons , you then have some sort of basic display on it so that if you're um sort of cha changing from different modes for the device it'll tell you just exactly what uh you know each direction of the uh of the um joystick's going to do or wha or what each function button's going to do .

@highlight

I'm responsible for working design , uh , this is basically the inside going on of the the uh remote control .

@highlight

So we have the energy source , we have the user interface , Uh the sender will push the button , the chip will respond , Do we need uh many buttons , or do we need l many light bulbs Um , the joystick is another thing , if we were gonna add that , um , there'd be more components to deal with that .

@highlight

you have the energy source obviously connected to the chip , You have the switch turn it on , infrared bulb , uh will contact the T_V_ do we need on the control uh different buttons to decide , or different light bulbs , Um , I dunno what we should decide on that .
...
however the idea of a joystick and then maybe an L_C_D_ which has been kind of put forward so far , but if you can control almost all of the functionality from the display , I don't know how much power an L_C_D_ would take , literally um if you can imagine the display maybe slightly larger than um those on a a mobile phone , something where you can read an an um fair amount of information , traverse maybe quite a few menus , Um and then we could have like say the common buttons as you say , volume control , changing channels I I was thinking that the remote the um sort of default functions for the joystick would be up and down for uh volume , left and right for channels .

@highlight

Do you think that people will get mixed up , they'll be looking at this screen and that screen Um I think probably for the first couple of hours of using it but we should probably try to stick to black and white .
...
but I think we don't have a specific audience , like what is our target audience , I think it could probably be aimed at most people who've used a mobile .

@highlight

Um , if we are if we were to follow that avenue , we might be s you know um we're kind of almost relying on their experience with a mobile phone I suppose .

@highlight

I imagine as well that the actual L_C_D_ and maybe to a certain extent the joystick as well would be for the additional functionality .

@highlight

Um and you can still have the main buttons that allow the people to turn the machine on and off , d up and down , maybe we have the fol um the joystick as a separate one for the other functions then , that there's just a a small number of as you were saying uh buttons that have already been defined .

@highlight

we go for the nice standard um up and down for and volume control .

@highlight

if you i if you wanted to access further functions i you you then get to sort of menu navigation .

@highlight

I mean with things like ch with things like tuning and channels um you know adjusting brightn uh brightness and fiddly things that no one really bothers with , most T_V_s these days actually have menus anyway I mean most of the uh of the replacement remote market is sort of remote control rationalisation .

@highlight

you want one wo y you want one that'll do the job of all of them .

@highlight

this is a requirement that we have to stick to I'm afraid , um would that include um access to say interactive functions on digital or cable ?

@highlight

I would say so , yes , I would say that the design spec we've been with is for the television only for now .

@highlight

Um maybe then our market should be T_V_ manufacturers , rather than the public .

@highlight

However I don't know exactly where we'll be going with that , It's just , the way I figure it , twelve point five Euros per unit , we have to sell at least like three million or something like that , something else that you brought up was uh the ability to lose a remote , but have any of you ever seen those odd little key rings where if you whistle , it will beep and you tell you where it is .

@highlight

I had one of those , because it it went off all the time accidentally .

@highlight

the other option of course is that um the The clapping one .

@highlight

Um digital telephones , uh for example , one unit has somewhere where there's a button , of course you have to have that base unit , but maybe it's a button that you attach to the T_V_ .
...
again say what , it would be a small transmitter , um watch battery type scenario I would say , that might be something that we could look into .

@highlight

that could be something that separates us a bit from the market as well .

@highlight

do we go for a small joystick that would operate say changing channels , up and down , Um we have to decide exactly what we're going to do with the remote .

@highlight

and then , what , another button that would say that it's now being used to manoeuvre round the L_C_D_ .
...
We could use say the left and right for changing channels we could maybe even go as far as saying power button , small joystick , L_C_D_ , and with the possibility of pushing down on the joystick to say okay ?
...
The o the o the other dis design constraint I think we should bear in mind is that people are you know very much used to using a remote control one handedly , Do Yeah , think so .

@highlight

So that would require a um transmitter maybe attached to the T_V_ , and what , a basically a small microphone um on the actual unit , Light bulb as well , a small speaker you mean .

@highlight

th e the true fact , considering the cost of an L_E_D_ , we could just incorporate it anyway .

@highlight

you could go for quite an interesting design .

@highlight

something that can make it stand out slightly .
...
um , user interface , we also need to maybe get the slogan in here , the slogan's we put the fashion in electronics , we can just incorporate into the actual plastic on top .
...
and um possibly the two R_s to signify the company .
