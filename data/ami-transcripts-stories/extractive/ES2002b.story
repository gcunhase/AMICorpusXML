...
Um kind of uh got to know each other a little bit and uh got familiar with all the equipment and started to discuss um a bit about the project , you know , cost-wise how much how much money we had to s Um just want to tell you that you have three new requirements , which is the The first one is that um uh the company's decided that teletext is outdated uh because of how popular the internet is .
...
uh th because on the the company website , uh what does it say 'Bout putting the fashion in electronics .

@highlight

I mean do they Is that something they want actually written on it , 'cause it's quite long .

@highlight

So those are the three things , just not to worry about teletext , uh only control the T_V_ , and um and uh incorporate the uh colour and slogan of the company .
...
Um so I believe the the advanced functions should maybe be hidden in a drawer , So , now I'd like to ask for your preferences .
...
I mean like the one on the left looks quite um quite complicated , Um so I see I see why yo you know you might prefer the simpler design , you know you get a lot of remote controls where you kind of flip the thing open , Um , do we have any functions that um we'd want on it ?
...
God , I wou I would say that's required , I mean there's no way anybody's gonna buy a remote control these days when if you can't actually individually select channels , uh any kind of like display controls at all do you think we need to worry about , Well I think I think es essentially what we're doing right now is we're categorising .
...
Um , so so far , just to recap you've got volume and channel control and There's um on and off , um volume and channel , and skip to certain channels with the numbers .

@highlight

Well , one one way I would look at this um would be that we a approach the different controls in terms of um like control types , so that for the user it's very clear what they want to do where they go .
...
and then maybe just things that would be nice if it could do would be things like audio set up and display set up and things like that , maybe like a mute button , I dunno whether this is for good or for bad but there'll be a lot of kind of uh redundancy in the in the the issues and the the uh the things .

@highlight

what I've already started doing is cr I created a slide in in my presentation here so that we kind of think well what's the cumulative effect of what we've taken from your ideas and and mine , Obviously obviously what you've just told me what you've just told me impacts a lot on what um like market research mm that that I've been Mm hard to know what where your role ends , yeah .
...
Um the vast majority would spend more money for it to look fancy as well , we'll see later , the vast majority would spend more money for um slightly more intuitive control , such as voice recognition .
...
they tend to use the most simple controls if for me this is sorta like three different different um inspirations , you know , one is that we want uh something that's high-tech but we want it to seem easy .
...
They get lost a lot , Um , takes time to learn how to use them .
...
Um I I haven't brought out one specific marketing idea , Well , um one of the things that we have to decide on by the end of the meeting is who we're gonna be um who's our our target audience , our target market .
...
it's somebody who's not gonna just use the remote that comes with their telly , I suppose , Um , I think it'll be the mid range to the high end market , in terms of people .

@highlight

Um 'Cause twenty five Euros for a remote , how much is that lo locally in pounds ?
...
It does it does fit with the market that we're sort of identifying , I think we are gonna have to narrow it down , and 'cause you know , there needs to be some kind of selling point to it .
...
I I think twenty five to thirty five is is is fair to add that in as a group as well Okay , so fifteen to thirty five , look fairly young .
...
so shall we make the decision uh to include speech recognition I I think one thing we should try not to avoid is not to say we have to use speech recognition right now , because um , based on what you've go y everybody's saying , right , you want something simple .
...
but what I'm saying is that we're we're trying to lock ourselves into a s particular kind of technology , rather than focusing on on exactly what are the features that we're gonna say , and then , you know , say speech recognition is good for this , speech recognition is not good for this .
...
um might have been a good idea to all deliver our presentations and then discuss , well it's good to get ideas out while they're fresh in mind .
...
And also it helps in terms of people not losing this , I reckon one problem with speech recognition is um I've actually seen one of them used and uh the technology that was in that one wasn't particularly amazing , so you end up yelling at the control for hours .
...
Um I guess I try to define like what we're doing now , but we're we can't n we haven't narrowed down um exactly what the things we're trying to fulfil , like I think back in the back of our minds we know what the basics are .
...
It just explains how the process goes through , from the basic technology point of view , the basic steps that you need 'Kay , a battery or something , to keep it going .
...
That might be constrained because that you might need to power a microphone , so that's one perhaps constraint there .

@highlight

Th Okay , the basic thing is there's a user interface You know , and that um picks up an input from a user , a series of logic has to decide what the user is telling the device , Um and then it needs to be able to send the signal out to the device itself like um voice recognition , right , if it's something which is important then we just add more power rather than having a thing that we don't have enough power .
...
Um you have a transmitter , an input device , logic chip , Since we're on the topic of the technology , uh are there any like what are our options ?

@highlight

Is this the only way that we go about it , or are there other thin Um , these these aren't technology options in that sense .
...
So each component represents one function , but I think the basic functions are the logic , the transmitter , um and the receiver , okay , and the power are things that you won't have to care about .
...
Uh does c is our controller is it have the option of being um on a standard uh frequency as all of the other equipment , There's there's not much specific specific information , In the new requirement spec they said just to focus on the T_V_ , Um , is it worth considering like having like a charging unit as opposed to just regular batteries ?
...
Okay , from from a from a component point of view there's added complexity , and you add cost to it , You need a docking cradle , for example , for you to put it in to charge .
...
Okay , so just stick to to regular was that um the the whole point of this meeting was to f absolutely finalise who we're gonna aim this at , I'm just gonna just recap uh what I said at the start , Are we all happy about the idea of um aiming the product at um the fifteen to thirty five bracket ?
...
And is it going to include any of the uh the more advanced features , I think we include mute , but apart from that um I think we just we'll go for the simpleness .

@highlight

is it not an option still that we include some things just as a sort of under like sort of under a door or some Yeah , it's as optional functions .
...
I mean like so what we could have is like three buckets , right , where we could throw things into , and then from there decide whether it's basic , or it's non-basic .
...
Um User Interface Designer gonna be thinking about our user interface , Um so uh I guess just to just to confirm that we know what we're doing in the next well in the thirty minutes after lunch anyway , Um and then we're gonna have thirty minutes of working on the next stage .
...
shall we agree for sake of um sort of clarity and when we when we r resume that we'll u use this idea David's proposed , where we think of these three sort of buckets and anything anything we discuss about them is sort of , okay , we're talking about this .
...
so you're gonna have um audio which is gonna be like you know your bass settings and actual volume hi And then video is anything that you can see .

@highlight

Okay , so brightness , contrast , things like that , And then k I suppose quite likely what would happen is in the d device category there might be some which are just like the habitual standard Um so yeah , I guess just things to think about are you know like the fact it's gotta look good , Um something maybe kind of quirky in design maybe .
