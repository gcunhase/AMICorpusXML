...
I'm project manager but on the meetings I'm also the secretary , which means I will make uh minutes Um if I'm right , there are three presentations , And um we will also take a look at new project requirements , um if you haven't heard about them yet .
...
Uh when you press a button , uh that's when you do pr for example when you uh want to turn up the volume , um a little connection is made on a little print plate Um uh the the chip uh makes a Morse code uh like uh signal which uh then is si uh signalled to uh several transistors And that makes uh the the infra-red lights signal which is sent to the television set .

@highlight

Um the findings uh uh that I found uh searching up some uh detailed information about the remote controls , are that uh they are very easy to produce , uh it's possible to uh make them in mass production Uh and the technology's already available , Uh I made a little uh uh animation of about how a tran our uh remote controller works .
...
Uh when it is pressed down , um , the switch is ter is uh is switched on , so with uh the wire is sent to the to the chip in uh co-operation with the battery of course , Uh I wrote down some personal preferences about uh the remote control .

@highlight

Of course it is very handy if the remote control is hand held , Uh I personally uh pref prefer that uh it would be p uh come available in the various colours , and uh easy to use buttons .

@highlight

Perhaps soft touch , uh touch screen uh buttons because uh the rubber buttons are always uh uh they uh slightly uh they can be slightly damaged , uh so the numbers on the buttons are not possible uh to read anymore .
...
and I looked at uh technical functions design of the remote .
...
Um well what I found was that uh th the actual use of the remote control is to send messages to television set , adjust volume , that kind of thing .
...
Um I guess you could better y you should look at a a user centred uh approach , A lot of buttons they may think from I don't need s as much as that .

@highlight

personal preferences is is uh a simple remote , with uh the basic functions that you can need that you could use .
...
If you have one that uh uh does with the vi the the video , it could also work with uh with the stereo , you could reuse the buttons And it should be a user friendly , clear buttons , and not too much .

@highlight

We're going to j discuss the functional requirements of the remote , that means that functions user n want to have on the remote control , The methods I I prefer is we're going to look which section of the users we are going to focus a l on more .
...
So we don't have to make it very small , like uh like a mobile phone or something , Seventy five percent of the users also find it ugly , and fif seventy five of the users zap a lot , so the buttons sh should be that small , or shouldn't be that complex Remote control has to have to have a low power usage , because s w seventy five percent of the users only zap one time an hour , The volume button and the channel buttons are the two most important buttons on the remote control , so those they those have to h be find very easily .
...
but like I said , L_C_D_ screen is easily to use And it should be easy to use .
...
then I think it's a good thing that I made a separate slide of them Um teletext does has become outdated since the popularity of the internet .
...
Uh the remote control should only be used for the television , otherwise the project becomes more complex , Um our current customers are within the age group of forty plus , and new product should reach a new market with customers that are younger than forty , And uh a last point , but also very important , our corporate image should stay recognisable in our products , which means that our uh corporate colour and slogan must be implemented in the new design .

@highlight

according to our agenda it's then time to take a decision on the remote control functions .

@highlight

you said it should only uh work with one appliance ?
...
Then it should have uh on , off , Standby options , the basics then by a volume , channel , one till two zero numbers on it , A button where you can uh change from one number to two numbers .

@highlight

because some T_V_s , if you press the t one and then the two , it be between five secs it make twelve , I think it's easy to implement a button with a s s what which especially do that , and that's that's not relaxed But uh all the television makes uh use of those button where you first press that button and then press two digits to uh to get new product should reach a market with customers that are younger than forty , Uh younger people have now , sixteen till to twenty five age , are f eighty one percent interested in L_C_D_ screen .
...
I don't have any costs here , But if you would do an L_C_D_ screen do we have don don't you have any buttons ?

@highlight

for example um if you wanted the minimal uh use b uh buttons , such as channel and volume , you just h uh displays four buttons on the screen and it's possible to p uh press them down , just like a touch screen .

@highlight

we're going for an L_C_D_ screen ?

@highlight

I think it's the most easier thing , but also on the older , But he also said that we should not only focus on the younger people , and will they use it if it only has an L_C_D_ screen ?
...
if you uh you receive an email about that , uh can you post it in the But for now it's L_C_D_ .
...
it'll look fancy with L_C_D_ screen .
...
what else does our remote need ?
...
The most important things on a f on an on an uh remote control are channel selection , volume con selection , and power s power usage .
...
and we could make an a a separate menu on the L_C_D_ uh screen for teletext .

@highlight

And other other less important things are screen settings , audio settings , and channel settings , they are less important , but I think they should be there , but in a sub sub-menu or something like that .

@highlight

Uh I think it's also important to uh make it possible to um how do you call it in English , uh , to not use batteries , Perhaps you should be able to to switch the control off .
...
If you have an L_C_D_ screen that's burns all the time I dunno .

@highlight

because I don't think people will like it who who uh that you have to turn it on first and then use it , so I think it's better when th the T_V_ shuts down , the remote shuts down .

@highlight

And go to standby mode when you don't use it , And maybe a low battery indicator ?
...
I think the batteries should should w should work a lot longer than a couple of days , uh it should be uh a standard move to to put your remote control in the charger when you're done watching television , that's also a a a great advantage because you can't lose it anymore .

@highlight

But then you also have to s have somewhere where you can put a remo recharger near your couch because otherwise you have to walk a long way when you twoft want to turn on the T_V_ .

@highlight

just a cable , or a even a a a a a charger where you can mount it on .

@highlight

Something like that , Functional designs uh for the elderly uh you could make it possible to enlarge the screen , so make it possible to not uh display uh a button at ten points I think that this should be standard .
...
twelve fifty , twelve fifty .

@highlight

I know let's do a speech .

@highlight

But they want to talk into the remo remote control , or something , I think an L_C_D_ screen should be suf sufficient .

@highlight

But when you look at the percentages but uh nobody knows uh how much uh it will cost uh .

@highlight

I think I think it's better to have L_ L_C_D_ screen , But would it be useful to imple implement both ?
...
but how would you like to implement that , that you say volume up , and then it goes up , Certain systems already exist , I think .
...
you can use icons it should be done .
...
so we only do this when we have enough money left .

@highlight

I've written down an an on or off button , volume selection , channel selection , uh the digits from one to zero , huh .
...
And uh the possibility to uh enlarge buttons or to have large buttons You also now have colours .
...
so not too much teletext support , but in a separate menu , We could check the other remote controls with technical functions .
...
wide screen , high screen , different things you have , it should be available , but then in separate screen settings or something .
...
and the buttons , should they have colours ?
...
we're having a a general menu with the most used functions , uh teletext , screen settings , audio settings , channel settings , Or do we have any buttons ?
...
So we don't have any normal buttons But that's also in the L_C_D_ , Maybe only the on and o on and off button .

@highlight

But isn't idea to use uh uh what you said , uh normal on and off button for the T_V_ , But a not as normal button , in the L_C_D_ , maybe there should be a separate button apart from the L_C_D_ , There has to be a on button on the remote , No you just tap I think .
...
I guess if you use the L_C_D_ screen , you first have to search where is the on button , But if you have a normal on button on the on the remote , then you do the on , I think it looks a lot more fancy if you use uh if you don't have any buttons on the s on on remote control .
...
that's might be a unique selling point , huh for a remote .

@highlight

postpone further discussion to uh our next meeting , for now , we're having a lunch break , and then there will be uh half an hour for the uh next share of individual work .
