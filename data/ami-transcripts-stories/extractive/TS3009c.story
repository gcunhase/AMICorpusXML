...
Uh such as an uh L_C_D_ screen , uh speech uh acknowledgement , as we uh talked about earlier .
...
Functional is not an issue , and then easy to use .
...
So Uh the buttons of course rubber , I think everyone agrees .
...
Soft materials is of course uh agai again a bit a contradiction with uh our uh material choice of what you said , And also they like curved round shapes .

@highlight

Maybe you should have uh some some coloured titanium or something .
...
But solar energy is not very practical inside a house , And uh kinetic and and and dynamos are are not very practical , I think , for uh for a simple remote , And I also suggest uh as a shape uh a double curved case .
...
But we do use an L_C_D_ screen , so we uh we do have to consider uh of we have to use a more advanced chip , Um there are new developments in speech recognition um systems , Um it's not really speech recognition , and then once you uh talk to the remote , then um he will a answer with the the prerecorded message that you left .
...
Well , as I said uh earlier I think the uh L_C_D_ screen should be uh positioned at the lower end of the remote .

@highlight

Um the buttons for screen width and general settings and uh and that kind of stuff um we can also do let that kind of functions um be shown in the L_C_D_ screen , uh instead of uh extra buttons .
...
Um the video button should be uh an apart button , But we need a we need a a recording recording button for the speech uh part .
...
if we decide to uh to implement that , maybe we should .
...
And oh I think as you can see so , the L_C_D_ screen does look better uh at the lower end , or at the bottom .
...
I think we should , if it's um possible , uh one with colours , but Nah th It's too expensive .
...
You can make the the underside , you can make it more round , where the L_C_D_ is .
...
Yeah but the non-removable elements of the of the remote , so not the front , could be titanium , And then the front is made of plastic .

@highlight

And you can put that on and off , But the feel of plastic isn't strong .
...
but you know b Titanium is very basic colour , and it doesn't really matter if we have a purple front on it or a orange front .
...
Yeah I think we can launch a couple of packages .
...
Well you can you can give them uh s s three or so , and that they want more .

@highlight

Yeah but you you can have some basic colours , yeah well I think we'll have to in the next uh half an hour , we'll have to uh s s specify the different uh types we want to launch , when we uh well introduce our remote .
...
Um I think um a logo , our company logo , and the slogan should be or could be Uh I I'd say only the logo .
...
But you can put it on the back , Right corner , yes .
...
The logo can be on on every uh front .

@highlight

Yes , slogan from company on the back with logo and logo also on the front So uh a little corner of titanium .
...
I was thinking of something like uh well uh iron plate over it , Yeah , that's great .

@highlight

uh I uh suggest uh the basic battery .

@highlight

No uh otherwi uh no um difficult scroll things or some uh things like that , Can you draw it now ?
