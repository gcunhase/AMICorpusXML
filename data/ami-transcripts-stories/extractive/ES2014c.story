...
Right well um from the last meeting I was trying to send you the minutes , but uh it didn't work out too well , so maybe in sort of um quick summary of the last uh meeting , I can quickly give you what we what we had .

@highlight

Right so we had the fact that we're gonna have the the logo uh the company logo in its uh colour scheme incorporated onto the the device the remote device .

@highlight

We had uh made our decisions about uh made our decisions about uh the device itself , that it was gonna be simple to make it uh enable us to complete the project in time .

@highlight

We're gonna have uh effectively two pages , a front page which had the uh features that the uh the customers most wanted , and then the uh the backup features on the second page so that it could uh meet the technical requirements .

@highlight

I think we all have a presentation again , For the components design , um next step is basically the the way the remote's gonna work is still the same idea as before .
...
Uh first in the power supply , we have the option of just the standard battery , There's a dynamo .

@highlight

There's a kinetic option , which would mean the batteries wouldn't have to be replaced .

@highlight

but I think that was gonna cost a little more .
...
For the buttons , we have um an integrated push button , which I guess is just the same as the standard ones .
...
Um there's a scroll wheel which is you know the new mouse has just got like the centre section which you can scroll up and down , Um one issue for the buttons is , depending on which material we use , if we use rubber buttons then it requires a rubber case , What would be the cost do do we know ?

@highlight

I th I think the there wasn't too much difference in the cost , that that related to the actual buttons , but it does affect the printed circuit board .
...
So if we've got the scroll wheel for one of the buttons , that would require a slightly more advanced circuit board than if we just had a standard um push button .
...
There's a small unit available through the company um which obviously would be an extra cost , Um going to my personal preferences , um I thought possibly for power we could use kinetic And this would avoid batteries running out , having to replace batteries and such like .
...
if we're gonna have the speech recognition , we'd have to probably get an advanced one .
...
So are we able to make that decision now in a sense that this is the point at which we're discussing that issue , I mean one way is to do each of the presentations and then make decisions going back to the various presentations as they were .

@highlight

that's probably a better one , to discuss it straight away .
...
Then if we were able to see that down then we could make the decision at that point in time As I say it only specified that we need a more advanced circuit board for the scroll wheel , The voice recognition came as a separate piece of information .
...
the scroll wheel required the regular , The display requires an advanced chip And note that the push button just requires a simple chip , Yeah , and if we're going for sleek and sexy , I think a scroll wheel is maybe a bit kinda bulky ?

@highlight

So maybe just a simple push button , Yeah , a simple pushbuttons .
...
But the way that I interpret that um it doesn't seem to send out a signal to the telly , it's like a parrot just rep reply replying to your message .
...
so we'd have a simple circuit board And I don't think you could really perform any of the remote functions with it .

@highlight

so we'd stick with the simple circuit board W w kinetic .

@highlight

I I thought so just for just for ease of not having to replace the batteries .
...
Are we going for speech recognition ?
...
It's it's just an addition thing And so we would want it in as an extra but Maybe we maybe we'll find out how much that does cost and have to decide slightly later .
...
All of them have a lot of buttons there um Um some of the uh remotes that I looked at , one of the models da did actually have voice recognition where you could um where it was connected to the remote control functions .

@highlight

And uh it was quite uh a swish model , I mean maybe it's better not to try and compete with that sort of thing Um the scroll buttons , as you've already mentioned , um there's examples of those , but they don't look as sleek as other models .

@highlight

and because it impacts on other on the materials and the price it's not great .
...
There was children's remote , where um they just had a very limited range of buttons and they were b uh bright and colourful and um you you could program them so that they could only look at certain channels .

@highlight

Well we're to go for the international market rather than a local market The one thing that you can often do with products is you can uh make small modifications .

@highlight

So you have your basic model which you would sell at whatever , and then you could have additional features You'd have model one , model two and model three , So maybe the children's remote should be like a a next step , but on this basic one I'm reckoning that we're going for the basic model to be discussed here and that uh you would have for future reference the possibility of adding in extra features at extra cost to take care of specialist market segments .

@highlight

Alright , so we're just gonna have the the rubber buttons , Um there was a mention just as kind of a warning about button design .
...
Um I think the thing was that if you decide to do this , to have triangular buttons , um somebody might look at this one and say oh well this triangular button is pointing up , they might see yeah , they might see this pointing down and think right that's gonna turn the volume down , whereas the actual button's pointing up , so the function is to turn the button up .
...
So maybe we could have volume written on the side I've I've got some things to say about possible design things from trend watching .

@highlight

Right , um I've been looking at some trends in in sort of basically fashion on top of doing the um research into the remote control market that we'd sort of asked people about remote controls and what what was good about them , what was bad , what they used .
...
And then sort of even wackier than that , we could maybe have a fruit or vegetable shaped remote , How how far we actually want to go along and sort of follow the trends , do we think the trends are particularly important for this type of gadget , or or you know , do they not matter that much ?
...
Well you were just talking about you've got to be careful how you shape your buttons , Maybe just one button , say the standby button is quite kinda separate from all the other functions .
...
I think because there's already um very good voice recognition technology out there , and because ours might not cover the same functions that the leading brands do , it might be a good idea to market it as a um finder function .

@highlight

the finder function rather than as a speech function to find your remote .

@highlight

th that that incorporates the trend whilst at the same time not confusing people , if you're looking for functionality .

@highlight

If y if you change all the buttons then you've got the problem that this year's fruit and veg , next year's uh I was gonna say animals or elephants or w whatever .

@highlight

I mean it just seems realistic that the remote control market isn't the kind of thing which takes in those kinds of fashion trends .
...
But I suppose as long as it's quite a subtle design , Maybe the spongy feel is something we could think about , um .

@highlight

Maybe still with a rubber design we could It seems like you're gonna have rubber cases , as well as buttons .
...
Whereas if you kept the product the same but you could have a difference from year to year , uh it seems to me that you could incorporate a fashion statement if you like , rather than changing the whole kit and caboodle .

@highlight

You're just changing one aspect like like the standby button or something like that , I suppose we maybe are limited in the fact that we still have to put the logo on the actual Maybe we could think of the the cases like changing with the fashions like the Nokia phones where you could take the casing off the outside .

@highlight

Oh but you still would have to have the logo on every new case , But we are supposed to use the um company colour scheme , aren't we ?
...
I mean a lot of um computers for instance like like on the one you've got there , it actually has a sort of um stick on badge And whether we'd have a big enough market to have this kind of like secondary market of selling the cases might be something to consider .
...
Okay , so if we just went for one colour of a rubber case whereas just the fact that it was a rubber case is probably less less of something that y you're gonna end up hating in a year , you know .
...
one thing to consider is that in some ways you want um by having a fairly standard case it means they can all fit together on top of each other therefore for storage purposes in shops and the like and it makes it easier that you can if you can store them up on top of each other .
...
and and the voice recognition , we can use that can't we , just to find it .
...
so it's not really spongy feel buttons , it's just rubber buttons .
...
Yeah 'cause we wanna incorporate a bit of colour if we can , Uh just to keep the shape of the buttons simple .
