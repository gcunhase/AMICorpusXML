...
And the end result of this meeting has to be a decision on the details of this remote control , um and then I'm gonna have to specify the final design in the final report .

@highlight

we said we were gonna have a snowman shaped remote control with no L_C_D_ display , no need for talk-back , it was hopefully gonna be kinetic power and battery uh with rubber buttons , maybe backlighting the buttons with some internal L_E_D_s to shine through the casing , um hopefully a jog-dial , and incorporating the slogan somewhere as well .
...
If you're using an advanced function right , like um c brightness , contrast , whatever , it will just say It might even be one , a bit more complex L_C_D_ panel with pictures like maybe the sun or the , you know , the the symbols of the various functions .
...
uh I'm just gonna bring up the idea of colours .

@highlight

this button um , because it's red it's sort of very prominent , we're gonna use it as uh it can be the power button if you hold it for maybe two seconds it'll send a stand-by signal .

@highlight

Um apart from that it's gonna be used as a confirm button for the L_C_D_ screen Oh we've discussed how h high it is , but how wide is it ?
...
but um because we've got the the L_C_D_ and the jog-dial we just thought we'd um use that as the volume .
...
Um you can use it for um more advanced functions like contrast , colour and Um a lot of these things will have to be um free and open for users to define them .
...
left-right balance , um maybe even pre-programmed sound modes , We can now have a little look at the the Excel sheet and price listing , and see if we need to um if we need to rethink anything at all .
...
Um we're at sixteen point eight and The other thing could be that um you could take away the L_C_D_ panel and the advanced chip together , so when we scroll we need just some way to get the T_V_ to respond , It It needs to be more than one big button because if you open up your phone , underneath there's actually one button underneath , it's just that the panel itself is a single panel .
...
Um so then these just become normal coloured buttons , And now we're under budget .

@highlight

sort of deep enough to be comfy to hold in your hands rather than being wide and flat .
...
but um just in in that we want this to be stylish , should we think a little bit more out of the box in terms of a button grid , I think that's something that's very hard to catch , so you you restrict the number of people who wanna try something .
...
Yeah Maybe we should do the design evaluation first .

@highlight

discuss uh how satisfied we all are with um with these four points , I've reviewed all of the um the points of discussion from the beginning , and used that as a criteria of evaluation for the um uh for the current design uh th or the plan , So to sort of b bring together two things , sort of design goals and also the market research that we had , uh when we rate this , one is v high in in succeeding or fitting to our original aim and seven is low , and um we've been asked to uh to collectively rate this , So the first one uh , stylish look and feel .
...
so we've had to remove a few of our features we wanted , but jog-dial Yeah about three , okay .
...
the the yellow is more representative of the colour , Okay , the blue the blue colours and don't re don't actually represent the colour , so we'll go two .

@highlight

and um design is simple to use , simple in features .
...
logo , we've got it in there , haven't we ?
...
out of forty nine with with zero being the highest .
...
It's not something I need to p push through , but I thought should we thinking more about the dimensions , um sort of like more of a three dimensional shapes as well as opposed to just that flat um uh well next up then , because we've done finance , is the project evaluation .

@highlight

Um well do you wanna um just individually say what you think about about these four points and Well d do you feel though that that you were able to have quite a lot of creative input into the thing ?

@highlight

Yeah , yeah it feels as though the creativity goes on when we leave , and then we come here and then we kind of put out our ideas and then , you know .
...
answering the question uh in those terms I'd say that actually there's sort of a tease of creativity We're told okay um think in terms of style and look and feel and technology , but build something for twelve and a half pounds , so actually the creativity was more more of like a um a f sort of a f formality then an actual The constraints do come in very fast .

@highlight

it's um it is quite a lot of fun t to go and then you have sort of hit the end then go right , gotta cut everything out 'cause we don't have enough money .

@highlight

I think another point is that the meetings um are more brainstorming sessions than meetings , and I think the fact that we're wearing these things restricts it it it does actually you know affect how , w whether you feel comfortable to communicate .

@highlight

and and the time the time given also restricts In in reality I think here the the different elements of leadership such as the the original b briefing and then the personal coach and the and then you know having having you with your the meeting agenda is actually quite a quite a quite a con confining framework to work within .

@highlight

And so it is leadership almost to the point of sort of disempowering the the the team member , so But it's not bad leadership , it's just sort of s fairly strong , you know .
...
So you think maybe a little too controlling or Yeah , oh yeah , without without a doubt .

@highlight

I don't think there's a sense of control 'cause all the decisions have been made in terms of a , like a consensus right , we go around and we think about it , Uh , reckon that was a bit hard because we could only discuss things in the meeting .
...
I know that people who design cars and you know in aviation they quite often just have a simple like fibreglass prototype and it's completely you know um abs abstract from the final product , but they use it as a kind of a context to sort of walk around and puzzle and and point and discuss and in a way everybody's as we discuss things in the in theoretically and out of our notebooks , we're actually just each of us discussing something that's in each of our own minds .

@highlight

I think um the the focus of it a lot was the PowerPoint as opposed to the to the whiteboard , and I think that m um is also does you know hinder us and things I think .

@highlight

And a lot of the information on the PowerPoints , I don't think , you know , we needed to actually it could have , we could have gone through it verbally , What about the digital pens , did you find them easy enough to use ?
...
Having to tick it before you go off was a bit hindering as well , But I think the pen is v is very intuitive , So I think the pen's good .

@highlight

And o on the topic of the technology , it just occurred to me that we actually didn't need to move our computers because each computer has all of the files .
...
I think it was quite good that we had time limits on the meetings because they really could have run on I really thi i I think maybe if we'd like all been working in the one room , and they just said you know like every hour or something everybody make sure yo you know just have a have a short meeting and then just c And we have Ninja Homer .
...
I'm slightly gutted that we couldn't get plastic and rubber , Oh , I did learn something new , Play-Doh is useful .
