...
I think you have to uh change your desktop uh Yeah my computer is not functioning properly .
...
This presentation is mainly based on my own ideas 'cause I hadn't time to intergrate tha the information yet so I'm gonna talk about functional requirements .
...
they are often lost somewhere in the room .
...
Uh most relevant , uh most used functions , Uh power button , uh channel , volume selection .

@highlight

Uh teletext but we can skip that because I saw the newsflash , and teletext is so outdated that it it's i should not be used uh any more in the future .
...
So No so it's a text file n in the project folder .
...
so the the logo has to be uh present yeah , and the colours as well .

@highlight

You pressed alt F_ four ?
...
And we do have to integrate the screen and the the speech Yeah but I prefer we we uh use the the basic options uh yeah .
...
So we have to make uh a compromise between functionality and fashional fashionable Well my presentation is a bit uh sucky .
...
But um yeah then uh the information came and it was kind of exact with all the steps in the remote control that I had to follow , so I was trying to organise them for myself .
...
and the T_V_ will translate it into a function .

@highlight

Okay shou should we make a list of the of all the functions we want uh for those that didn't see yet um the basic new requirements of the management were no teletext , only for T_V_ .

@highlight

Uh it should be designed for a use g uh group below forty , And uh the corporate identity should be clear in the design of the remote control .

@highlight

the marketing research started on s on the age of sixteen .
...
The the simple functions for for the the whole public , and the the advanced options for the younger people yeah who are more yeah experienced with uh I w I should uh put uh the the yeah the extra advanced options on the onto the onscreen display .
...
so it should fit right in into your hand .
...
most of the time you have one button in the middle .

@highlight

It says menu , and then if you press it you the screen gets activated and then you can use these buttons to scroll up and down and left and right to go into functon and then uh on on each on each screen there's there should be an option to go back to a to a upper level .

@highlight

But it should be if the screen is here then the logo should be like on on top , And for the speech uh recognition part , if we want to incorporate that , we need a microphone .
...
So we put this on top , and then make the corporate logo I mean this is basically numbers , volume , uh channel up and down .

@highlight

Yeah so we we needed to integrate the sound and uh and image options right ?
...
you have basically a button menu , which you can use directly , uh according to the old principle .

@highlight

And the L_C_D_ options are activated by some some software options , thats communicates with the infrared uh decoder yeah .
...
The User Interface Designer can design a menu for all these function and I think you can concentrate more on the button placement and the placement of the uh screen itself on the Uh all the functional uh aspects of the remote I think are in my department .
...
Menu button access the menu in the L_C_D_ screen .
...
The pr the problem with the okay button in the middle is , sorry , uh is uh if you're pressing up and down , you can easily press the okay once you , when you're not already at your choice .
...
yh we have lunch break , and then we can work for thirty minutes , and I have to write very fast to make the minich min minutes .
...
I think you can put uh the laptop back in the room and Yeah okay .
