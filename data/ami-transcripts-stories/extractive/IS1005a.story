...
We are talking about the project plan , Um .
...
Well , from experience , um I've had remote controls in the past that have had very they've had lots and lots of buttons and they've been very small , and it's been very hard to to to use , because there's so many buttons , you know , on a T_V_ remote you only ever use , mostly , you know , f four or f six buttons .
...
Uh first would be that in current remote controls there is no back light , so if you are if you are uh playing with this in the dark room it's it's probably worth to to have something like uh back light .
...
Are you not afraid that if you take your remote control you can move the slide and it could the the volume can go up very quickly Yeah but we can we can think of these things afterwards , I uh I prefer um remote control working with radio waves , because remote control working with infra-red rays you should you should you should keep it in a specific direction and then try it hard to tune .
...
Uh the the interface interface developer will work on the on the design of the remote control , you are going to try to to find the user requirements f uh for the remote control .