...
Um And that it should look different than what's out there .

@highlight

Um uh I think we decided that um the expense was not necessarily worth it , Um and that we didn't wanna go with a universal remote , because uh increasing cost and increasing complexity .
...
Um Um something that will fit into uh easily into someone's hand .
...
Um okay the most important finding was that the fancy look-and-feel seems to be twice as important to the users as the current functional look-and-feel design , Um the second most important finding was that the remote should be technologically innovative .
...
But I think that , even if it's very subtle , we need to kind of trick our consumers , We brought up the idea of having two pieces , which we could discuss further .

@highlight

We need to keep it simple , have limited buttons , so they at least get the idea that they're getting something that's new and modern and sleek and Um we need to incorporate this fashion trend of fruits and vegetables .

@highlight

So maybe we could have something that's somewhat removable , I mean I guess the two options are if we had our remote in the shape of a fruit or vegetable .
...
Um I was sent some information from the company saying that they , the technology department have devised a new speech recognition technology , where you can program questions into such devices .
...
Um there's a graphical use , where you you look at pictures and well on a screen .
...
And then on the right is obviously an iPod , and all that is is just a a nice big scroll menu that y you sort of go through .
...
Um then there's things like this , which is a a a kid's remote , where the the parents have the facility to control and program what children can watch before .
...
it could be a graphical display , the actual remote contr the actual control port maybe could have like an iPod where you just sort of control through the menus .
...
top left side you can see the chip , which is the , what we were talking about , this was is the device to recognise the signals the input , Its job is to wait for you to press a key , then to translate that key press into infrared light signals , um that are received by the television .
...
So um obviously I personally have to say that dynamo is out of the question really .
...
however when it comes to the scroll wheel of the iPod I've one big objection and that is that we have to fit an L_C_D_ into the remote control as well .

@highlight

If we have a more sophistic uh sophisticated scroll wheel rather than this very basic uh set-up that we that I've just presented , um the chip has to be more s more sophisticated and thus more expensive as well .

@highlight

solar cells cannot be used on a curved or latex um surface or um remote control .
...
With rubber we could uh sh pretty much shape it the way we wanted it , but we cannot add scroll wheels , and we cannot add an L_C_D_ screen .
...
I think having a shape could be a little ridiculous , How about um affecting the surface of the actual um remote control ?

@highlight

Say we don't make it p a particular fruit shape obviously , but uh give it like the surface of an orange , banana , whatever .
...
Well we sort of rid of that because gonna use a battery .

@highlight

Well we can still design a two-piece uh remote um without having a base , having one of them be a base station , Okay when it comes to the chip-on-print , as I said , the the more advanced features you want , um the fancier the chip has to be and the more expensive .
...
So I guess the case would be plastic , with Perhaps that's not even enough rubber to qualify as being part of it .
...
Um Manuel you'll be working on the look-and-feel design .
...
And the two of you get to play with the uh modelling components and uh maybe and and get us a prototype .

@highlight

basically just be working on the prototype , uh we'll accomplish your other two actions .