...
Uh uh just going to go quickly through the minutes of the last last uh meeting then we have a p presentation of prototype of you two , And we'll have um presentation of evaluation crit criteria by ou our Marketing Experts .
...
No L_C_D_ , no speech recognition technology , okay , we went through a b to a banana look and feel for the remote control .
...
This is when you when you uh are scrolling the uh through the channels you can tell it to to skip th past channels that you quickly rather th Well when you stop scrolling the wheel it stops .

@highlight

If you take the banana as such and uh you press the turbo button , so it switch ons the switch ons the T_V_ .
...
I constructed a a list of criteria based on the on the general user requirements .

@highlight

so we must users must say i if it's true or is or if it's false in a in a scale ranging from zero to seven .
...
Because it should be an even it should be an even uh scale , I think I sh I I could write the criteria in the on the whiteboard ?

@highlight

Okay let's let's evaluate if it's fancy or Yeah , it's fancy , according to me .
...
but maybe loses the point for not having you know the extra buttons when you reall if you do need them for some reason like I'd I think it's probably more handy than my current remote , 'cause of the scroll wheels Functional .
...
Actually I don't know what are the r the real specification of a of a universal remote contro Well it's not a universal remote .
...
For a T_V_ the most important feature which I felt was the locator which is a cool feature .
...
If i i it depends , if you live in in Switzerland or you live in Wha the initial specifications were for the whole all Europe or I don't want a banana on my living room table , a banana remote .
...
don't forget who we're targeting also No , it's I .

@highlight

I would buy I don't think I at any stage in my life I would want a banana remote control , really .
...
If it was change my remote control of my D_V_D_ player for a Mando banana then I would be more inclined to I'd say a three .
...
Well actually that that no that sample speaker is not we we're not using that , we're just using the the very beep simple beep , Oh there is no listing for r radio frequency thing .
...
Well no didn't we say we wanted to do a rubber Okay so special colour , yellow .
...
but you know the turbo button does add that extra class .
...
So might be ninety centimes for the the remaining things which the cord and everything which'll go so we have margin for that stuff .
...
Because yeah the evaluation for us is is kind of pointless .

@highlight

So but I think that's something we need to to work on next time is really finding out more about the target market .

@highlight

I think that's actually something that should be in version two , is the ability to you know to control things other than the T_V_ I think we we can go Okay so thanks very much .