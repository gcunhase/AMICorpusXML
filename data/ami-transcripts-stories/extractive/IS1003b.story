...
I will open our functional design meeting .

@highlight

we will have the three presentations from the In Industrial Designer , User Interface Designer and um And after that we uh will have the uh new product requirements , I suppose the first to do the presentation will be the User Interface Designer .
...
did you save your presentation ?
...
Three Isn't that technical functions ?
...
The first I will present the technical function design for user interface for our uh remote T_V_ control .

@highlight

remote c rem remote T_V_ control it's very has very soph sophisticated functions , so we want to design uh elegant , easy to use inter interface .
...
So my job is to uh design a Google T_V_ controller which I want to have sophisticated functions while with very easy to use user interface .

@highlight

So you propose to to have the remote control which will be powerful .

@highlight

With sophisticated functions , and very easy to use .

@highlight

it's maybe difficult to have both , I mean the the one on the right doesn't look so simple But if we have very very good user interface it take less time for user to learn how to use it .

@highlight

but the question is how to merge you know the Google system to the system , alright .

@highlight

As you all know , you know m my job is to design you know uh to give an industrial design of the remote control .

@highlight

I propose a nifra infrared base I think it's cheaper than laser , so .

@highlight

what you find inside the re i the the system here inside it is just , you know a bulb and an infrared bulb , I have some kind of pictures and you have the other subcomponent There's a wire with remote control ?

@highlight

I think it should be wire wireless re remote con and you know because you f the b the the battery problem can hold you know will you use a battery or the a wire to connected you .
...
maybe it will be cheaper I dunno but as Industrial Designer , do you think that it will be feasible to have uh linked or to have link between the remote control and the television ?
...
Have to think about the question , but I think the wireless problem is more the um David Jordan's problem .

@highlight

Mayb maybe you have just to to kind of research If when you have wireless remote control and if you lose it ?

@highlight

I think it's would be easier to have a link between the remote control and the television , So just trying to answer all the questions , We had one hundred subjects , um , we observe their remote control use in a lab and then after all the experiments they had to fill up a questionnaire , um , Um actually seventy five percent of the users find m the most remote controls uh ugly , Yeah , the the look is is bad for them Then eighty percent of users would spend more money um actually if if the remote controls were not so ugly .
...
And uh users are actually zapping a lot , ten percent of the buttons are actually used in the remote control .
...
And uh remote control are really bad for R_S_I_ problems for twenty six percent of the users .
...
If we can make it look fancy then we might sell more than our uh concurrent , And definitely if it could have less buttons , still maybe the same number of um functions , but less buttons , And just to have uh an idea , do you think you as the User Interface Designer to would it be possible to have less buttons and still have the same functionality and to have powerful remote control , you think it's possible ?
...
Because we can We can uh mix uh several function in one button .

@highlight

but do you think it will be easy to use ?
...
you you can have a switch menu , but it has to be intuitive .

@highlight

For example , if you have remote control you you can rem you can control your T_V_ and also you can control your uh recorder .
...
I think the solution is to have many colours of you know instead of having one grey standard but I think it will increase the price of the production of the remote control .

@highlight

Maybe we can have di di we can have uh several options , so maybe just having many functions in one button is not that good if you want to zap a lot .

@highlight

new information about the product requirements , the first one is that um for the designing of the remote control we don't really want to use the teletext anymore , because so it's better to use internet then teletext .

@highlight

and also the remote control will only be used for television , you won't had um buttons to just to manipulate yeah to control the recorder or maybe the garage door or things like that .
...
which will be used for for the television , for the recorder , for the camcorder and all the others , it will become too complex And also we want the image of the uh um real reaction be recognisable in the product , such as the colour and s the slogan .
...
Require lot of requirements , but this this mean that your T_V_ would be able to , you know , connect to internet , you know , surf the web .

@highlight

There's that box in the T_V_ , so with the set box you you can connect internet with your T_V_ .

@highlight

I don't think it's popular , I think it has to be yellow .

@highlight

I think if you have you know th like a yellow ribbon here is the double R_ .
...
Doesn't need to be completely yellow , I will close the meeting , um just after that we'll have lunch break .
...
You will have as the I_D_ I don't remember what is industr Industrial Designer to put um pon Component component , yeah .
...
Regarding the first line , what So we're just expecting no more use of the teletext .

@highlight

But I dunno , but why , I think it would be simpler .