...
the materials for the case , the different energy sources , the different types of chips , um and made a decision on what we were going to use to make our remote .

@highlight

basically we we st went with the colour yellow .
...
And the the simplest functions would be um almost identical to an iPod , And then to access the more complicated functions you'd you sorta go , you press that and go through the menus .

@highlight

we could use the voice .
...
So uh to answer that honestly I would rather say like uh , we have not solved the problem completely with the ugly remote because the colour is ugly , definitely .
...
Which makes this thing raise hell when you remove it too far from the television .
...
It's all just stolen technology when it comes down to I don't know that we are that innovative , to tell you the truth .
...
did we put the fashion in electronics ?
...
Well the recent fashion is rather displayed in the in the L_C_D_ and the way you operate it than the form and the colour , Now we just gotta calculate .
...
I suppose the L_C_D_ C_ display's the one that's pushing it up a bit though .

@highlight

you could maybe take out the L_C_D_ dis display even , Right .
...
Um Our leadership was quite weak in the beginning .
...
and um I think it was um interesting as you guys brought up more um information and studies that we were right on with a lot of those things .
...
I had some problem with the pen I think , Minus your PowerPoint fiasco .
...
Um so there will probably be another questionnaire coming up .
