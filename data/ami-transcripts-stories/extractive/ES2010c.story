...
We're gonna have three presentations , And then we are going to come to decision on the remote control concepts Okay , so trend watching .

@highlight

fifty eight per cent of the decision of what it should look like , fancy versus functional , and then it has to also be technologically innovative , and yet easy to use .
...
But as for the fruits and vegetable patterns , I don't know if we really want to go with that , um we need easy to read like large buttons , clearly labelled And I was thinking about different types of designs and I came up with something .

@highlight

So what we could do is something like an old-fashioned telephone where we put the buttons around , like we'd put a big on-off button or something else in the middle , So it's classically retro .
...
Um uh can't really see , but there's two possible ways , on the r left , if you see on th on the sides of of the remote , you have the sort of scroll down , And then on the right , we have what's really big trend right now , it's the iPod .
...
and then down at the bottom you have the logos and that's where you could put the R_R_ , Real Reaction .

@highlight

But it's sort of like just taking aspects out of that and saying , well out of this one we like , you know the round section of um , b or we'd like the the button size on this .

@highlight

So basic remote operation runs as follows , we need rubber for buttons , aluminium for battery y contacts , integrated circuit which consists of a diode , transistor , resonator , resistors , and a capacitator , um contact discs for the buttons , plastic for the casing , and a power-source , whatever power-source we've actually determined we want .

@highlight

They suggested power options , solar cells , hand dynamo , and kinetic power , Um I'm not sure how the hand dynamo works , We can offer options for casing such as straight , curved , double-curved , you know , very specific to the customer .
...
Um the manufacturing division also has said that um they have several types of chips and they've just developed a sample sensor or sample speaker chip , which we could utilise .
...
um there's a sample sensor and there's a sample speaker unit for So , you would say like , good morning , coffeemaker , and it would respond , good morning , Jill , I'm not sure exactly how it's gonna work , 'cause do you programme do we program the responses and the questions .

@highlight

I feel like voice recognition would be , I don't know , w it would be too hard to really If it's within our price to get that kind of chip that would , you know , technology But , I guess , we have to look at w what our production cost is for the chip itself anyway .

@highlight

let's let's see if we can decide what kind of energy source we want to have first and foremost .
...
Honestly , I think the customer would be kind of irritated by the fact that it has a base I think if we had a a locating device with the small one , I think that seems way more advanced .
...
or we could do one small lithium , I ki I kind of like your idea about the retro phone dial , because w And then would the buttons be too small if it was enough to fit on it ?

@highlight

'cause if you have the circle and the button in the middle , then is it gonna get wider than your your hands are , which I think if we make it curved like a hand like a hand-shape like if we put the the scroll-button on the side , Well , the other option is in instead of a scroll you just have the buttons up on the side which are on the side .
...
I think maybe we should do it on a b button itself though , or if we're going for the retro look , I think , like a really shiny black would be cool .

@highlight

or like a gun-metal grey , I'm just really wary of the putting anything on a button .
...
Like a little cut-out kind of Um and then if v we do have them illuminate upon contact , they could illuminate yellow .

@highlight

The I_D_ is going to do the look and feel design , the U_I_D_ the user interface design .
...
I think you're going to get a lot of , I mean , the final say on what buttons get put 'Kay .
